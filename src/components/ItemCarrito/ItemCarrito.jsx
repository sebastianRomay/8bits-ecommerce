    ...
    return (
        <div className='container'>
            <div className='row mt-5 mb-5'>
                ...
                <div className='col-2 fw-bold'>ID: <br/> <span>{item.id}</span>  </div>
                ...
                <div className='col-2 fw-bold'>Precio: <br/> <span>${item.price}</span> </div>
                <div className="col-1"><button className='btn btn-outline-danger w-10' onClick={()=>eliminarPorId(item.id)}>X</button></div>  
            </div>
            </div>
